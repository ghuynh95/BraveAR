...
app.updateEvent.addEventListener(function (frame) {
  ...
  for (var i = 0; i < bases.length; i++) {
    var baseGeoPose = app.context.getEntityPose(baseEntities[i]);
    if (baseGeoPose.poseStatus & Argon.PoseStatus.KNOWN) {
      baseTargets[i].position.copy(baseGeoPose.position);
    }
  }
